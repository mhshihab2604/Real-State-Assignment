...
const Contact = () => {
    return (
        <div>
            ...
            <section className="py-6 dark:bg-gray-100 dark:text-gray-900 mt-32">
                <div
                    ...
                    <form noValidate="" className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
                        ...
                        <button
                            type="button"
                            className="self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ring-opacity-75 dark:bg-[#71B100] dark:text-gray-50 focus:dark:ring-[#71B100] hover:dark:ring-[#71B100]">Submit</button>
                    </form>
                </div>
            </section>
        </div>
